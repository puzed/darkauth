...
- Keybag account-key and envelope operations.
...
- Install-time OPAQUE registration for the first admin with fresh install-token validation on each bootstrap step.
