...
import { setOrganizationMemberRolesAdmin } from "../../models/rbacAdmin.js";
import { requireSession } from "../../services/sessions.js";
import type { Context, ControllerSchema } from "../../types.js";
import { withAudit } from "../../utils/auditWrapper.js";
import { parseJsonSafely, readBody, sendJsonValidated } from "../../utils/http.js";

const RequestSchema = z.object({ roleIds: z.array(z.string().uuid()) });
...
const handler = async (
  ...
  const result = await setOrganizationMemberRolesAdmin(
    context,
    organizationId,
    memberId,
    parsed.roleIds
...
export const putOrganizationMemberRoles = withAudit({
