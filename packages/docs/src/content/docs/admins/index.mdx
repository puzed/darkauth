...
- Configure federation and SCIM provisioning.
...
If you are installing a new instance, start with [Install](/admins/install/) and [Configuration](/admins/configuration/). If you already have a running instance, review [Clients](/admins/clients/), [Federation](/admins/federation/), [SCIM](/admins/scim/), [Users](/admins/users/), [Organizations and RBAC](/admins/organizations-rbac/), and [Audit Logs](/admins/audit-logs/).
