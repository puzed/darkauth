...
export const postOtpDisable = withAudit({ eventType: "OTP_DISABLE", resourceType: "user" })(
  withRateLimit("otp_disable")(async function postOtpDisable(
    context: Context,
    ...
    await disableOtp(context, "user", session.sub as string);
