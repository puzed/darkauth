...
After you unlock once, other tabs in the same browser stay unlocked until you sign out or the sign-in ends. Approved apps also skip the approval screen when they ask for the same access.
