...
export async function getWellKnownOpenidConfiguration(
  ...
  const configuration = {
    ...
    userinfo_endpoint: `${publicOrigin}/api/userinfo`,
    introspection_endpoint: `${publicOrigin}/api/introspect`,
    revocation_endpoint: `${publicOrigin}/api/revoke`,
    end_session_endpoint: `${publicOrigin}/api/logout`,
