import {
  defaultDarkBrandingColors,
  defaultLightBrandingColors,
...
export async function getBrandingConfig(context: Context): Promise<BrandingConfig> {
  ...
  return {
    ...
    colors: normalizeBrandingColors(colors as BrandingConfig["colors"] | undefined, "light"),
    colorsDark: normalizeBrandingColors(
      colorsDark as BrandingConfig["colorsDark"] | undefined,
      "dark"
    ),
...
export async function ensureBrandingDefaults(context: Context): Promise<void> {
  const brandingDefaults = {
    ...
    colors: defaultLightBrandingColors,
    colorsDark: defaultDarkBrandingColors,
    wording: {
