...
Password reset restores account access. It does not automatically recover encrypted content protected by old password-derived material without another recovery envelope or app recovery path. Applications using zero-knowledge protected data must provide and document their own recovery story.
